<template>
  <div class="layui-card">
    <div class="layui-card-header" style="height: 50px">菜单管理</div>
    <div class="layui-card-body">
      <div class="app-container calendar-list-container">
        <div class="filter-container">
          <el-button-group>
            <el-button
                    v-permission="{'value':'sys_menu_add'}"
                    type="primary"
                    icon="plus"
                    @click="handlerAdd">添加
            </el-button>
            <el-button
                    v-permission="{'value':'sys_menu_edit'}"
                    type="primary"
                    icon="edit"
                    @click="handlerEdit">编辑
            </el-button>
            <el-button
                    v-permission="{'value':'sys_menu_del'}"
                    type="primary"
                    icon="delete"
    ...
    data() {
      return {
        ...
        rules: {
          ...
          title: [{ required: true, message: '标题不合法', trigger: 'blur' }],
